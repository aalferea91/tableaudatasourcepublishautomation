...
REM tabcmd login -s https://dummyaddress.tableau.com -u typeusername -p typepassword
REM This command is used to switch from one directory to another. 
cd .\File_1 
